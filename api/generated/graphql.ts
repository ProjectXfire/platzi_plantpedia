...
export type IAssetFieldsFragment = { __typename?: 'Asset' } & Pick<
  IAsset,
  'title' | 'url' | 'width' | 'height'
>

export type IAuthorFieldsFragment = { __typename?: 'Author' } & Pick<
  IAuthor,
  'fullName' | 'handle' | 'biography' | 'twitter' | 'linkedIn'
> & {
    sys: { __typename?: 'Sys' } & Pick<ISys, 'id'>
    photo?: Maybe<{ __typename?: 'Asset' } & IAssetFieldsFragment>
  }

export type ICategoryFieldsFragment = { __typename?: 'Category' } & Pick<
  ICategory,
  'slug' | 'title' | 'categoryDescription'
> & {
    sys: { __typename?: 'Sys' } & Pick<ISys, 'id'>
    icon?: Maybe<{ __typename?: 'Asset' } & IAssetFieldsFragment>
  }

export type IPlantFieldsFragment = { __typename?: 'Plant' } & Pick<
  IPlant,
  'slug' | 'plantName'
> & {
    sys: { __typename?: 'Sys' } & Pick<ISys, 'id'>
    image?: Maybe<{ __typename?: 'Asset' } & IAssetFieldsFragment>
    description?: Maybe<
      { __typename?: 'PlantDescription' } & Pick<IPlantDescription, 'json'>
    >
    author?: Maybe<{ __typename?: 'Author' } & IAuthorFieldsFragment>
    category?: Maybe<{ __typename?: 'Category' } & ICategoryFieldsFragment>
  }
...
export type IGetPlantListQuery = { __typename?: 'Query' } & {
  plantCollection?: Maybe<
    { __typename?: 'PlantCollection' } & Pick<
      IPlantCollection,
      'total' | 'skip' | 'limit'
    > & { items: Array<Maybe<{ __typename?: 'Plant' } & IPlantFieldsFragment>> }
  >
}
...
export type IGetPlantQuery = { __typename?: 'Query' } & {
  plantCollection?: Maybe<
    { __typename?: 'PlantCollection' } & {
      items: Array<Maybe<{ __typename?: 'Plant' } & IPlantFieldsFragment>>
    }
...
export type ISearchPlantQuery = { __typename?: 'Query' } & {
  plantCollection?: Maybe<
    { __typename?: 'PlantCollection' } & Pick<
      IPlantCollection,
      'total' | 'skip' | 'limit'
...
export type IGetCategoryListQuery = { __typename?: 'Query' } & {
  categoryCollection?: Maybe<
    { __typename?: 'CategoryCollection' } & {
      items: Array<Maybe<{ __typename?: 'Category' } & ICategoryFieldsFragment>>
    }
  >
}
...
export type IGetAuthorListQuery = { __typename?: 'Query' } & {
  authorCollection?: Maybe<
    { __typename?: 'AuthorCollection' } & {
      items: Array<Maybe<{ __typename?: 'Author' } & IAuthorFieldsFragment>>
    }
  >
}
...
export type IGetPlantListByAuthorQuery = { __typename?: 'Query' } & {
  plantCollection?: Maybe<
    { __typename?: 'PlantCollection' } & {
      items: Array<Maybe<{ __typename?: 'Plant' } & IPlantFieldsFragment>>
    }
...
export type IGetPlantListByCategoryQuery = { __typename?: 'Query' } & {
  categoryCollection?: Maybe<
    { __typename?: 'CategoryCollection' } & {
      items: Array<Maybe<{ __typename?: 'Category' } & ICategoryFieldsFragment>>
    }
